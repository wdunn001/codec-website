`F6cf`!codec-metamcp (Docker)`!`f

`F999MetaMCP gateway with Codec binary transport. The MCP aggregator, but tool-call results ship as length-prefixed msgpack instead of newline-delimited JSON-RPC.`f
