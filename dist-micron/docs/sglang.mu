`F6cf`!sglang (vanilla)`!`f

`F999Run upstream sglang with the Codec patches applied yourself. Use this when you need a custom build; otherwise prefer the pre-built codec-sglang Docker image.`f
