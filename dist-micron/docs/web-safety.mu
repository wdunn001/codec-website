...
├────────────────────┼──────────────────────────────────────────────────────────────┼──────────┤
│ 'secrets'          │ AWS / GitHub / OpenAI / Anthropic / Google / Slack / Stripe  │ 'AKIA…', │
...
│                    │                                                              │ vendor   │
│                    │                                                              │ API keys │
│ 'dangerous_action' │ Jailbreak templates, malware/exploit authoring asks,         │ 'ignore  │
│                    │ destructive command literals                                 │ previous │
│                    │                                                              │ instruct │
│                    │                                                              │ ions',   │
│                    │                                                              │ 'write   │
│                    │                                                              │ working  │
