`F6cf`!v0.4, safety-policy negotiation as a TLS-style capability axis`!`f

`F9992026-05-11 - v0.4 - feature`f
...
CHANGELOG.md (https://github.com/wdunn001/Codec/blob/main/CHANGELOG.md)

spec/versions/v0.4.md (https://github.com/wdunn001/Codec/blob/main/spec/versions/v0.4.md)

2026-05-11T00-12-00Z bench matrix (https://github.com/wdunn001/Codec/blob/main/packages/bench/results/2026-05-11T00-12-00Z/MATRIX.md)

docs/RELEASE_CHECKLIST.md (https://github.com/wdunn001/Codec/blob/main/docs/RELEASE_CHECKLIST.md)
