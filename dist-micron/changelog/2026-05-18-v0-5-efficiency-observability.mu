...
GitHub Release v0.5.0 (https://github.com/wdunn001/Codec/releases/tag/v0.5.0)

CHANGELOG entry (https://github.com/wdunn001/Codec/blob/main/CHANGELOG.md#v050--2026-05-18)

Cross-stack matrix (https://github.com/wdunn001/Codec/blob/main/packages/bench/results/2026-05-17T23-06-45Z/MATRIX.md)

IETF Internet-Draft (draft-dunn-codec-00) (https://github.com/wdunn001/Codec/blob/main/docs/submissions/draft-dunn-codec-00.md)

sglang upstream PR (https://github.com/sgl-project/sglang/pull/25544)

vLLM upstream PR (https://github.com/vllm-project/vllm/pull/42896)
