`F6cf`!codec-metamcp v0.3.1 (leaf-mode validator fix); Codec-aware tools 4.2× e2e`!`f

`F9992026-05-09 - v0.3.1 - fix`f
...
GitHub release v0.3.1 (https://github.com/wdunn001/Codec/releases/tag/v0.3.1)

2026-05-09T11-10-48Z bench results (https://github.com/wdunn001/Codec/tree/main/packages/bench/results/2026-05-09T11-10-48Z/mcp)

metamcp validator-fix commit (https://github.com/wdunn001/metamcp/commit/e8c3fca)
