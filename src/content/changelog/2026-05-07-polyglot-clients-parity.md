---
title: Java, Rust, and .NET clients reach feature parity
date: "2026-05-07"
kind: feature
summary: Six client libraries (TypeScript, Python, Java, Rust, .NET, C) are now byte-identical across the cross-stack benchmark matrix. 36 cells × 3 sizes, all green.
links:
  - label: GitHub release v0.2.4
    url: https://github.com/wdunn001/Codec/releases/tag/v0.2.4
  - label: Cross-stack benchmark matrix
    url: https://github.com/wdunn001/Codec/blob/main/RESULTS.md
---
