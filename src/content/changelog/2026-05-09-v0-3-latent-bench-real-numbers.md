---
title: v0.3 latent bench, pipeline math validates byte-for-byte
date: "2026-05-09"
kind: feature
version: v0.3.4
summary: First end-to-end latent run against codec-diffusers with real SD-1.5 latents on the wire. The seven-pipeline registry collapses bytes exactly as the spec promises (int4 packs 3.9× over raw, ~5-10× smaller than JPEG).
links:
  - label: GitHub release v0.3.4
    url: https://github.com/wdunn001/Codec/releases/tag/v0.3.4
  - label: 2026-05-09T13-01-55Z latent results
    url: https://github.com/wdunn001/Codec/tree/main/packages/bench/results/2026-05-09T13-01-55Z/latent
  - label: spec/PIPELINES.md (the registry being validated)
    url: https://github.com/wdunn001/Codec/blob/main/spec/PIPELINES.md
---
