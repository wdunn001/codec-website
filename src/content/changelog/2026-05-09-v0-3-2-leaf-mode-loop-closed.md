---
title: v0.3.2, leaf-mode bypass observable end-to-end on real MCP traffic
date: "2026-05-09"
kind: feature
version: v0.3.2
summary: The Codec leaf-mode bypass (the architectural target the entire v0.3 contract was designed for) fires end-to-end. `[Codec][leaf]` log line confirms the gateway is a transparent ID pipe; the tokenizer sits at the leaf where it belongs.
links:
  - label: GitHub release v0.3.2
    url: https://github.com/wdunn001/Codec/releases/tag/v0.3.2
  - label: 2026-05-09T12-17-48Z bench results
    url: https://github.com/wdunn001/Codec/tree/main/packages/bench/results/2026-05-09T12-17-48Z/mcp
  - label: PROTOCOL.md § Tool-call calling conventions in the map
