...
A Codec-aware gateway like [codec-metamcp](/docs/codec-metamcp/) detects the leaf-mode result and bypasses its back-compat shim:
...
Or the Docker image, dropped into a [codec-metamcp](/docs/codec-metamcp/) namespace:
