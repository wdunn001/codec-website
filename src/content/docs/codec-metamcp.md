...
> **Live as of v0.3.2.** The `[Codec][leaf]` log fires end-to-end on real lab traffic. See the
...
- [codec-sglang](/docs/codec-sglang/) / [codec-vllm](/docs/codec-vllm/) / [codec-llamacpp](/docs/codec-llamacpp/), inference engines on the other side of the gateway.
- [TypeScript](/docs/typescript/) / [Python](/docs/python/) walkthroughs, client patterns for any Codec endpoint, including this one.
